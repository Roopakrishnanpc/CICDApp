...
stage("pushing the helm charts to nexus"){
            ...
            steps{
                script{
                    ...
                    def userInput = input message: "Deploy ${params.project_name}?", parameters: [
...
//					def deployGate = userInput['DeployGate']
//                    
//                    // Evaluate the Boolean parameter
//                    if (!deployGate) {
            ...
            steps {
                script {
                    ...
                    withKubeConfig(caCertificate: '', clusterName: 'kubernetes', contextName: '', credentialsId: 'kubernetes-jenkins-secret', namespace: 'jenkin',  serverUrl: 'https://10.138.0.17:6443') {
                        ...
                        chmod u+x ./kubectl
                        ./kubectl run curl --image=curlimages/curl -i --rm --restart=Never -- curl myjavaapp-cicdapp:8080/home -n jenkin'''
                }
            }
        }
    }
